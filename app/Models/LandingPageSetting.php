...
class LandingPageSetting extends Model
{
    ...
    public static function getSettings()
    {
        ...
        if (!$settings) {
            ...
            $companyName = isSaas() ? 'PeYug SaaS' : 'PeYug';

            $settings = self::create([
                'company_name' => $companyName,
                'contact_email' => 'admin@peyug.in',
                'contact_phone' => '+91-9615641564',
    ...
    private static function getSaasConfig()
    {
        return [
            'sections' => [
                ...
                [
                    'key' => 'hero',
                    'title' => 'Pay with PeYug',
                    'subtitle' => ' Scan and pay instantly on any QR with PeYug UPI. Download the PeYug app now for a seamless payment experience.',
                    'announcement_text' => '📢 New:Welcome to PeYug ',
        ...
        return [
            'sections' => [
                ...
                [
                    'key' => 'about',
                    'title' => 'About PeYug',
                    'description' => 'Welcome to PeYug – Empowering Every Step of Your Financial Journey',
                    'story_title' => 'Welcome to PeYug – Empowering Every Step of Your Financial Journey',
                    'story_content' => 'Under the visionary leadership of our Founder, Mr. Niranjan Verma, PeYug – "The New Era of Payment", a proud venture of THE JINL COOPERATIVE MULTIPURPOSE SOCIETY LTD, is driven by a clear and powerful mission — to become a trusted, world-class financial service provider dedicated to empowering individuals and communities through cooperative values.',
                    'image' => '',
                    'background_color' => '#f9fafb',
                    'layout' => 'image-right',
                    'stats' => [
            ...
            'seo' => [
                'meta_title' => 'PeYug – Empowering Your Financial Journey',
                'meta_description' => 'PeYug – The New Era of Payment. Empowering individuals and businesses with seamless financial solutions.',
                'meta_keywords' => 'PeYug, payment solutions, UPI, financial services, cooperative society'
            ],
            'custom_css' => '',
            'custom_js' => '',
            'section_order' => ['header', 'hero', 'features', 'screenshots', 'why_choose_us', 'about', 'team', 'testimonials', 'plans', 'faq', 'newsletter', 'contact', 'footer'],
