...
if (! function_exists('defaultSettings')) {
    ...
    function defaultSettings()
    {
        $settings =  [
            ...
            // Brand Settings
            'logoDark' => 'logo/logo-dark.jpg',
            'logoLight' => 'logo/logo-dark.jpg',
            'favicon' => 'logo/favicon.jpg',
            'titleText' => isSaas() ? 'PeYug SaaS' : 'PeYug',
            'footerText' => isSaas() ? '© 2024 PeYug SaaS. All rights reserved.' : '© 2025 PeYug. All rights reserved.',
            'themeColor' => 'green',
            'customColor' => '#10b981',
