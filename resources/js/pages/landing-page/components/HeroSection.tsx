        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl font-medium">
              {sectionData.subtitle ||
                'Manage employees, payroll, attendance, and more in one powerful platform.'}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              {isSaas && (
                <Link
                  href={route('register')}
                  className="text-white px-8 py-4 rounded-lg font-semibold flex items-center justify-center gap-2 hover:opacity-90"
              ...
              <Link
                href={route('login')}
                className="border px-8 py-4 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-gray-50"
          ...
          <div className="relative">
            <div
              ...
              style={{ height: `${sectionData.height || 300}px` }}
            >
              <img
                src={
                  heroImage ||
                  getImageUrl(
                    globalSettings?.is_saas
                      ? '/screenshots/saas/hero-default.png'
                      : '/screenshots/non-saas/hero-default.png'
                  )
                }
                alt="Hero"
