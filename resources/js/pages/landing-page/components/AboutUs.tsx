...
export default function AboutUs({ settings, sectionData, brandColor = '#3b82f6' }: AboutUsProps) {
  ...
  icon: 'target',
  title: 'Our Mission',
  description: 'To empower individuals and businesses with secure, smart, and seamless digital banking solutions that simplify everyday financial operations.'
},
{
  icon: 'heart',
  title: 'Our Values',
  description: 'We value trust, transparency, innovation, and customer-centricity—ensuring every user enjoys a smooth, reliable, and supportive banking experience.'
},
{
  icon: 'award',
  title: 'Our Commitment',
  description: 'Delivering fast, secure, and intuitive banking services backed by exceptional support to help customers manage, grow, and protect their finances.'
},
{
  icon: 'lightbulb',
  title: 'Our Vision',
  description: 'A future where banking is fully digital, accessible to all, and powered by smart technology—helping people achieve financial freedom with confidence.'
}
  ...
  const defaultStats = [
    { value: '20+ Years', label: 'Experience', color: 'blue' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {sectionData.title || 'About PeYug SaaS'}
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
            {sectionData.description || 'Welcome to PeYug – Empowering Every Step of Your Financial Journey'}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              {sectionData.story_title || 'Welcome to PeYug – Empowering Every Step of Your Financial Journey'}
            </h3>
            <div className="text-gray-600 mb-8 leading-relaxed" dangerouslySetInnerHTML={{
              __html: (sectionData.story_content || 'Under the visionary leadership of our Founder, Mr. Niranjan Verma, PeYug – "The New Era of Payment", a proud venture of THE JINL COOPERATIVE MULTIPURPOSE SOCIETY LTD, is driven by a clear and powerful mission — to become a trusted, world-class financial service provider dedicated to empowering individuals and communities through cooperative values.').replace(/\n/g, '</p><p className="mb-6">')
            }} />
