...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-leave-applications')->group(function () {
            ...
            Route::put('hr/leave-applications/{leaveApplication}/status', [\App\Http\Controllers\LeaveApplicationController::class, 'updateStatus'])->middleware('permission:first-approve-leave-applications|final-approve-leave-applications|reject-leave-applications')->name('hr.leave-applications.update-status');
        });
        ...
        Route::middleware('permission:manage-attendance-records')->group(function () {
            ...
            Route::get('/hr/attendance/export-pdf', [\App\Http\Controllers\AttendanceRecordController::class, 'exportAttendancePdf'])
                ->name('hr.attendance.export.pdf');
            Route::get('/hr/attendance/export-csv', [\App\Http\Controllers\AttendanceRecordController::class, 'exportAttendanceCsv'])
                ->name('hr.attendance.export.csv');
...
Route::get('/live-locations', [EmployeeController::class, 'liveLocationDashboard']);
